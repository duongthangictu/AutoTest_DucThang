...
public class CommonBase2 {
	private static final String URL = null;
	public WebDriver driver;
	protected String baseUrl = "https://staging.capa.ai/";
	protected int DEFAULT_TIMEOUT = 20000; // đợi 20s
	 ...
	 * @param URL
	 */
	public WebDriver initDriverTest(String... URL) { // String... URL: truyền parameter động, có thể truyền bn tùy theo ý mình
