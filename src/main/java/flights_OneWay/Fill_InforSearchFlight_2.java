...
//	@FindBy(xpath = "(//label[text()='Passengers']/following::div)[2]")
	@FindBy(xpath = "(//a[@class='dropdown-toggle dropdown-btn' and @role='button'])[1]")
//	@FindBy(xpath = "(//label[text()='Passengers']/following::span)[1]")
	private WebElement passengers;
	
	private By passengers_2 = By.xpath("(//a[@class='dropdown-toggle dropdown-btn' and @role='button'])[1]");
	...
	private By adults_Add_2 = By.xpath("(//div[@class='qtyInc'])[1]");
...
//		((JavascriptExecutor) driver).executeScript("arguments[0].click()", passengers);
//		clickJavaScript(passengers_2);
		pause(3000);
//		clickJavaScript(adults_Add_2);
//		((JavascriptExecutor) driver).executeScript("arguments[0].click()", adults_Add);
		/*
		 * ((JavascriptExecutor) driver).executeScript("arguments[0].click()",
		 * children_Add); ((JavascriptExecutor)
		 * driver).executeScript("arguments[0].click()", infants_Add);
		 * 
		 * // Coach ((JavascriptExecutor) driver).executeScript("arguments[0].click()",
		 * coach); ((JavascriptExecutor) driver).executeScript("arguments[0].click()",
		 * coachValue);
		 * 
