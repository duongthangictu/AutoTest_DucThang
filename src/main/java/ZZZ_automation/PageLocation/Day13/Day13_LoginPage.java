package ZZZ_automation.PageLocation.Day13;
...
public class Day13_LoginPage {
	...
	/*
	 * public By getTextEmail() { return textEmail; }
	 * 
	 * public void setTextEmail(WebDriver textEmail) { this.textEmail = (By)
	 * textEmail; }
	 * 
	 * public By getTextPass() { return textPass; }
	 * 
	 * public void setTextPass(WebDriver textPass) { this.textPass = (By) textPass;
	 * }
	 */
	public void Login(String email, String pass) {
		...
		/*
		 * >> Di chuyen sang Day13_LoginTest để vào case Login succesfully WebElement
		 * titleDashboard = driver.findElement(Day13_DashboardPage.textDashboard);
